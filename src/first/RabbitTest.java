...
public class RabbitTest {
	...
	public static void main(String[] args) {
		...
		int n1 = rabbit(10);
		System.out.println("Result of calling rabbit(10): " + n1);
		
		int n2 = exercise5(10);
		System.out.println("Result of calling exercise5(10): " + n2);
	}
 ...
 * 1. Line 3
 * 2. Line 5
 * 3. The method returns the nth of fibonacci number.
 * 4. The exercise5 does the same as rabbit method. But it is more efficient than rabbit method.
 * 5. It is a bad use of recursion. The rabbit method called 109 times according the output. It wastes much more time.
 * 6. To write down the times of calling. The number indicate the times of calling.
